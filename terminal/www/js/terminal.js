...
qoid.QoidAPI.createNotification = function(kind,data,context,route) {
	...
	qoid.QoidAPI.submitRequest(json,qoid.QoidAPI.NOTIFICATION_CREATE,new qoid.RequestContext("context"));
};
