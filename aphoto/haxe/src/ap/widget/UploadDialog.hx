...
typedef UploadDialogOptions = {
}

typedef UploadDialogWidgetDef = {
	@:optional var options: UploadDialogOptions;
...
@:native("$")
extern class UploadDialog extends JQ {

	@:overload(function<T>(cmd : String):T{})
	@:overload(function(cmd:String, opt:String, newVal:Dynamic):JQ{})
	function UploadDialog(?opts: UploadDialogOptions): UploadDialog;

	private static function __init__(): Void {
		var defineWidget: Void->UploadDialogWidgetDef = function(): UploadDialogWidgetDef {
			return {
		        initialized: false,

		        _create: function(): Void {
		        	var self: UploadDialogWidgetDef = Widgets.getSelf();
					var selfElement: JQDialog = Widgets.getSelfElement();
		        	if(!selfElement.is("div")) {
		        		throw new Exception("Root of UploadDialog must be a div element");
		        	}

		        	selfElement.addClass("_UploadDialog").hide();
		...
		JQ.widget( "ui.UploadDialog", defineWidget());
	}
}