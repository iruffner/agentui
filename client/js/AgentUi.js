...
var defineWidget = function() {
	return { _create : function() {
		...
		while(connIter.hasNext()) {
			var connection = ui.helper.OSetHelper.getElementComplex(ui.AgentUi.USER._getCurrentAlias().connectionSet,connIter.next());
