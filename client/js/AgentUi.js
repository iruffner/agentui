...
ui.api.ProtocolMessage.prototype = {
	...
	,toJson: function() {
		return { msgType : Std.string(this.msgType), contents : this.getContents()};
	}
	,contents: null
	,msgType: null
