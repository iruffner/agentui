...
m3.observable.EventManager.prototype = {
	...
	,add: function(l) {
		Lambda.iter(this._set,function(it) {
			l(it,m3.observable.EventType.Add);
		});
...
m3.observable.ObservableSet.prototype = $extend(m3.observable.AbstractSet.prototype,{
	current: function(t_in) {
		var uid = (this.identifier())(t_in);
...
m3.observable.MappedSet.prototype = $extend(m3.observable.AbstractSet.prototype,{
	current: function(t_in) {
		var uid = (this._source.identifier())(t_in);
		var iter = this._source.iterator();
		while(iter.hasNext()) {
			var t = iter.next();
...
ui.AppContext.init = function() {
	...
	ui.AppContext.INTRODUCTIONS = new m3.observable.GroupedSet(new m3.observable.ObservableSet(function(n) {
			...
			var loginRequest = new ui.api.StandardRequest(request,function(data,textStatus,jqXHR) {
				if(data.msgType == ui.api.MsgType.initializeSessionResponse) try {
					...
					while(_g1 < _g11.length) {
						...
						alias.label = alias_;
						alias.set_uid(m3.util.UidGenerator.create(12));
					...
					user.get_currentAlias().connectionSet = new m3.observable.ObservableSet(ui.model.Connection.identifier,response.contentImpl.listOfConnections);
...
ui.api.IntroductionNotificationData.__super__ = ui.api.PayloadWithSessionURI;
ui.api.IntroductionNotificationData.prototype = $extend(ui.api.PayloadWithSessionURI.prototype,{
	__class__: ui.api.IntroductionNotificationData
});
ui.api.IntroductionConfirmation = function() {
	ui.api.ProtocolMessage.call(this,ui.api.MsgType.introductionConfirmation,ui.api.IntroductionConfirmationData);
};
$hxClasses["ui.api.IntroductionConfirmation"] = ui.api.IntroductionConfirmation;
ui.api.IntroductionConfirmation.__name__ = ["ui","api","IntroductionConfirmation"];
ui.api.IntroductionConfirmation.__super__ = ui.api.ProtocolMessage;
ui.api.IntroductionConfirmation.prototype = $extend(ui.api.ProtocolMessage.prototype,{
	__class__: ui.api.IntroductionConfirmation
});
ui.api.IntroductionConfirmationData = function() {
	ui.api.PayloadWithSessionURI.call(this);
};
$hxClasses["ui.api.IntroductionConfirmationData"] = ui.api.IntroductionConfirmationData;
ui.api.IntroductionConfirmationData.__name__ = ["ui","api","IntroductionConfirmationData"];
ui.api.IntroductionConfirmationData.__super__ = ui.api.PayloadWithSessionURI;
ui.api.IntroductionConfirmationData.prototype = $extend(ui.api.PayloadWithSessionURI.prototype,{
	__class__: ui.api.IntroductionConfirmationData
});
ui.api.MsgType = $hxClasses["ui.api.MsgType"] = { __ename__ : ["ui","api","MsgType"], __constructs__ : ["initializeSessionRequest","initializeSessionResponse","initializeSessionError","connectionProfileResponse","sessionPing","sessionPong","closeSessionRequest","closeSessionResponse","evalSubscribeRequest","evalSubscribeResponse","evalComplete","evalError","stopEvalRequest","stopEvalResponse","createUserRequest","createUserError","createUserWaiting","confirmEmailToken","createUserResponse","updateUserRequest","updateUserResponse","insertContent","feedExpr","addAgentAliasesRequest","addAgentAliasesError","addAgentAliasesResponse","removeAgentAliasesRequest","removeAgentAliasesError","removeAgentAliasesResponse","setDefaultAliasRequest","setDefaultAliasError","setDefaultAliasResponse","getAliasConnectionsRequest","getAliasConnectionsResponse","getAliasConnectionsError","getAliasLabelsRequest","getAliasLabelsResponse","getAliasLabelsError","addAliasLabelsRequest","addAliasLabelsResponse","updateAliasLabelsRequest","updateAliasLabelsResponse","beginIntroductionRequest","introductionNotification","introductionConfirmation"] }
...
ui.api.MsgType.stopEvalRequest = ["stopEvalRequest",12];
ui.api.MsgType.stopEvalRequest.toString = $estr;
ui.api.MsgType.stopEvalRequest.__enum__ = ui.api.MsgType;
ui.api.MsgType.stopEvalResponse = ["stopEvalResponse",13];
...
ui.api.MsgType.introductionNotification = ["introductionNotification",43];
ui.api.MsgType.introductionNotification.toString = $estr;
ui.api.MsgType.introductionNotification.__enum__ = ui.api.MsgType;
ui.api.MsgType.introductionConfirmation = ["introductionConfirmation",44];
ui.api.MsgType.introductionConfirmation.toString = $estr;
ui.api.MsgType.introductionConfirmation.__enum__ = ui.api.MsgType;
...
ui.api.TestDao.buildConnections = function() {
	...
	george.set_uid(m3.util.UidGenerator.create());
	...
	elaine.set_uid(m3.util.UidGenerator.create());
	...
	kramer.set_uid(m3.util.UidGenerator.create());
	...
	toms.set_uid(m3.util.UidGenerator.create());
...
ui.api.TestDao.getUser = function(uid) {
	...
	user.set_uid(m3.util.UidGenerator.create());
	...
	alias.connectionSet = new m3.observable.ObservableSet(ui.model.Connection.identifier,ui.api.TestDao.connections);
	alias.connectionSet.visualId = "TestAliasConnections";
	alias.labelSet = new m3.observable.ObservableSet(ui.model.Label.identifier,ui.api.TestDao.labels);
...
ui.helper.ModelHelper.asConnection = function(alias) {
	...
	conn.set_uid(alias.get_uid());
	conn.profile = new ui.model.UserData(alias.label,alias.imgSrc);
	return conn;
}
...
ui.helper.PrologHelper._processDataLogChildren = function(parentLabel,parser) {
	...
	while(term != null && term != ")") {
		if(StringTools.startsWith(term,"n")) {
			...
			l.set_uid(m3.util.UidGenerator.create(10));
			if(parentLabel != null) l.parentUid = parentLabel.get_uid();
			larray.push(l);
...
ui.model.EMEvent.DeleteLabels = ["DeleteLabels",21];
...
ui.model.EMEvent.INTRODUCTION_NOTIFICATION = ["INTRODUCTION_NOTIFICATION",24];
...
ui.model.EMEvent.INTRODUCTION_CONFIRMATION = ["INTRODUCTION_CONFIRMATION",25];
...
ui.model.EMEvent.CONNECTION_UPDATE = ["CONNECTION_UPDATE",26];
ui.model.EMEvent.CONNECTION_UPDATE.toString = $estr;
ui.model.EMEvent.CONNECTION_UPDATE.__enum__ = ui.model.EMEvent;
ui.model.EMEvent.TARGET_CHANGE = ["TARGET_CHANGE",27];
...
ui.model.ModelObj.prototype = {
	...
	,get_uid: function() {
		if(m3.helper.StringHelper.isBlank(this.uid)) this.set_uid(m3.util.UidGenerator.create(10));
		return this.uid;
	}
...
ui.model.Alias = function() {
	...
	this.labelSet.listen(function(l,evt) {
		ui.model.EM.change(ui.model.EMEvent.CreateLabel);
	});
};
...
var defineWidget = function() {
	return { options : { connection : null, classes : null}, _create : function() {
		...
		(js.Boot.__cast(selfElement , $)).droppable({ accept : function(d) {
			...
			if(dropper.get_uid() != droppee.get_uid()) ui.widget.DialogManager.requestIntroduction(dropper,droppee);
		}, tolerance : "pointer"});
	}, update : function() {
		var self = this;
		var selfElement = this.element;
...
var defineWidget = function() {
	return { _create : function() {
		...
		self.content.mapListen(function(content,contentComp,evt) {
			if(evt.isAdd()) {
				new $("#postInput").after(contentComp);
				ui.model.EM.change(ui.model.EMEvent.FitWindow);
	...
	return { _showNewLabelPopup : function(reference) {
		...
		popup = popup.popup({ createFcn : function(el) {
			...
			while(iter.hasNext()) {
				...
				if(self.selectedLabelComp != null && ui.widget.LabelCompHelper.getLabel(self.selectedLabelComp).get_uid() == label.get_uid()) option += " SELECTED";
		...
		ui.model.EM.addListener(ui.model.EMEvent.AliasLoaded,new ui.model.EMListener(function(alias) {
			self1._setLabels(alias.labelSet);
		},"LabelsList-Alias"));
		...
		getLabelDescendents = function(label1,label_list) {
			...
			var children = new m3.observable.FilteredSet(self1.labels,function(child) {
				return child.parentUid == label1.get_uid();
			}).asArray();
		...
		menu.m3menu({ menuOptions : [{ label : "New Child Label", icon : "ui-icon-star", action : function(evt,m) {
			evt.stopPropagation();
			...
			menu.hide();
			return false;
		}},{ label : "Delete Label", icon : "ui-icon-circle-close", action : function(evt,m) {
...
var defineWidget = function() {
	return { _create : function() {
		...
		self1.userImg = new $("<img alt='user' src='" + imgSrc + "' class='userImg shadow'/>");
		self1.container.append(self1.userImg);
		...
		self1.userImg.click(function(evt) {
			new $(".nonmodalPopup").hide();
			menu.show();
			menu.position({ my : "left top", of : evt});
			evt.stopPropagation();
		});
		self1.userIdTxt = new $("<div class='userIdTxt'></div>");
		self1.container.append(self1.userIdTxt);
		...
		self1.userIdTxt.append("<strong>" + name + "</strong>").append("<br/>").append("<font style='font-size:12px'>" + aliasLabel + "</font>");
		var changeDiv = new $("<div class='ui-helper-clearfix'></div>");
		self1.container.append(changeDiv);
		if(user != null) {
			self1.changeAliasLink = new $("<a class='aliasToggle'>Change Alias</a>");
			changeDiv.append(self1.changeAliasLink);
			var aliases = new $("<div class='aliases ocontainer nonmodalPopup' style='position: absolute; min-width: 100px;'></div>");
			self1.container.append(aliases);
			...
			if(iter != null) while(iter.hasNext()) {
				...
				var btn = new $("<div id='" + alias1[0].get_uid() + "' class='aliasBtn ui-widget ui-button boxsizingBorder ui-state-default'>" + alias1[0].label + "</div>");
				if(alias1[0].get_uid() == user.get_currentAlias().get_uid()) btn.addClass("ui-state-active");
				aliases.append(btn);
				btn.hover((function() {
					return function() {
						$(this).addClass("ui-state-hover");
			...
			aliases.hide();
			self1.changeAliasLink.click(function(evt) {
				aliases.toggle();
				evt.stopPropagation();
			});
		}
...
m3.observable.AbstractSet.__rtti = "<class path=\"m3.observable.AbstractSet\" params=\"T\" module=\"m3.observable.OSet\">\n\t<implements path=\"m3.observable.OSet\"><c path=\"m3.observable.AbstractSet.T\"/></implements>\n\t<_eventManager><c path=\"m3.observable.EventManager\"><c path=\"m3.observable.AbstractSet.T\"/></c></_eventManager>\n\t<visualId public=\"1\"><c path=\"String\"/></visualId>\n\t<listen public=\"1\" set=\"method\" line=\"110\"><f a=\"l\">\n\t<f a=\":\">\n\t\t<c path=\"m3.observable.AbstractSet.T\"/>\n\t\t<c path=\"m3.observable.EventType\"/>\n\t\t<x path=\"Void\"/>\n\t</f>\n\t<x path=\"Void\"/>\n</f></listen>\n\t<filter public=\"1\" set=\"method\" line=\"114\"><f a=\"f\">\n\t<f a=\"\">\n\t\t<c path=\"m3.observable.AbstractSet.T\"/>\n\t\t<x path=\"Bool\"/>\n\t</f>\n\t<c path=\"m3.observable.OSet\"><c path=\"m3.observable.AbstractSet.T\"/></c>\n</f></filter>\n\t<map public=\"1\" params=\"U\" set=\"method\" line=\"118\"><f a=\"f\">\n\t<f a=\"\">\n\t\t<c path=\"m3.observable.AbstractSet.T\"/>\n\t\t<c path=\"map.U\"/>\n\t</f>\n\t<c path=\"m3.observable.OSet\"><c path=\"map.U\"/></c>\n</f></map>\n\t<fire set=\"method\" line=\"122\"><f a=\"t:type\">\n\t<c path=\"m3.observable.AbstractSet.T\"/>\n\t<c path=\"m3.observable.EventType\"/>\n\t<x path=\"Void\"/>\n</f></fire>\n\t<getVisualId public=\"1\" set=\"method\" line=\"126\"><f a=\"\"><c path=\"String\"/></f></getVisualId>\n\t<identifier public=\"1\" set=\"method\" line=\"130\"><f a=\"\"><f a=\"\">\n\t<c path=\"m3.observable.AbstractSet.T\"/>\n\t<c path=\"String\"/>\n</f></f></identifier>\n\t<iterator public=\"1\" set=\"method\" line=\"134\"><f a=\"\"><t path=\"Iterator\"><c path=\"m3.observable.AbstractSet.T\"/></t></f></iterator>\n\t<delegate public=\"1\" set=\"method\" line=\"138\"><f a=\"\"><x path=\"Map\">\n\t<c path=\"String\"/>\n\t<c path=\"m3.observable.AbstractSet.T\"/>\n</x></f></delegate>\n\t<new set=\"method\" line=\"106\"><f a=\"\"><x path=\"Void\"/></f></new>\n\t<meta><m n=\":rtti\"/></meta>\n</class>";
m3.observable.ObservableSet.__rtti = "<class path=\"m3.observable.ObservableSet\" params=\"T\" module=\"m3.observable.OSet\">\n\t<extends path=\"m3.observable.AbstractSet\"><c path=\"m3.observable.ObservableSet.T\"/></extends>\n\t<_delegate><c path=\"m3.util.SizedMap\"><c path=\"m3.observable.ObservableSet.T\"/></c></_delegate>\n\t<_identifier><f a=\"\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<c path=\"String\"/>\n</f></_identifier>\n\t<add public=\"1\" set=\"method\" line=\"158\"><f a=\"t\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<x path=\"Void\"/>\n</f></add>\n\t<addAll public=\"1\" set=\"method\" line=\"162\"><f a=\"tArr\">\n\t<c path=\"Array\"><c path=\"m3.observable.ObservableSet.T\"/></c>\n\t<x path=\"Void\"/>\n</f></addAll>\n\t<iterator public=\"1\" set=\"method\" line=\"170\" override=\"1\"><f a=\"\"><t path=\"Iterator\"><c path=\"m3.observable.ObservableSet.T\"/></t></f></iterator>\n\t<isEmpty public=\"1\" set=\"method\" line=\"174\"><f a=\"\"><x path=\"Bool\"/></f></isEmpty>\n\t<addOrUpdate public=\"1\" set=\"method\" line=\"178\"><f a=\"t\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<x path=\"Void\"/>\n</f></addOrUpdate>\n\t<delegate public=\"1\" set=\"method\" line=\"190\" override=\"1\"><f a=\"\"><x path=\"Map\">\n\t<c path=\"String\"/>\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n</x></f></delegate>\n\t<update public=\"1\" set=\"method\" line=\"194\"><f a=\"t\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<x path=\"Void\"/>\n</f></update>\n\t<delete public=\"1\" set=\"method\" line=\"198\"><f a=\"t\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<x path=\"Void\"/>\n</f></delete>\n\t<identifier public=\"1\" set=\"method\" line=\"206\" override=\"1\"><f a=\"\"><f a=\"\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<c path=\"String\"/>\n</f></f></identifier>\n\t<clear public=\"1\" set=\"method\" line=\"210\"><f a=\"\"><x path=\"Void\"/></f></clear>\n\t<size public=\"1\" set=\"method\" line=\"217\"><f a=\"\"><x path=\"Int\"/></f></size>\n\t<asArray public=\"1\" set=\"method\" line=\"221\"><f a=\"\"><c path=\"Array\"><c path=\"m3.observable.ObservableSet.T\"/></c></f></asArray>\n\t<current public=\"1\" set=\"method\" line=\"230\"><f a=\"t_in\">\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t<c path=\"m3.observable.ObservableSet.T\"/>\n</f></current>\n\t<new public=\"1\" set=\"method\" line=\"149\"><f a=\"identifier:?tArr\">\n\t<f a=\"\">\n\t\t<c path=\"m3.observable.ObservableSet.T\"/>\n\t\t<c path=\"String\"/>\n\t</f>\n\t<c path=\"Array\"><c path=\"m3.observable.ObservableSet.T\"/></c>\n\t<x path=\"Void\"/>\n</f></new>\n\t<meta><m n=\":rtti\"/></meta>\n</class>";
m3.observable.MappedSet.__rtti = "<class path=\"m3.observable.MappedSet\" params=\"T:U\" module=\"m3.observable.OSet\">\n\t<extends path=\"m3.observable.AbstractSet\"><c path=\"m3.observable.MappedSet.U\"/></extends>\n\t<_source><c path=\"m3.observable.OSet\"><c path=\"m3.observable.MappedSet.T\"/></c></_source>\n\t<_mapper><f a=\"\">\n\t<c path=\"m3.observable.MappedSet.T\"/>\n\t<c path=\"m3.observable.MappedSet.U\"/>\n</f></_mapper>\n\t<_mappedSet><x path=\"Map\">\n\t<c path=\"String\"/>\n\t<c path=\"m3.observable.MappedSet.U\"/>\n</x></_mappedSet>\n\t<_remapOnUpdate><x path=\"Bool\"/></_remapOnUpdate>\n\t<_mapListeners><c path=\"Array\"><f a=\"::\">\n\t<c path=\"m3.observable.MappedSet.T\"/>\n\t<c path=\"m3.observable.MappedSet.U\"/>\n\t<c path=\"m3.observable.EventType\"/>\n\t<x path=\"Void\"/>\n</f></c></_mapListeners>\n\t<identifier public=\"1\" set=\"method\" line=\"279\" override=\"1\"><f a=\"\"><f a=\"\">\n\t<c path=\"m3.observable.MappedSet.U\"/>\n\t<c path=\"String\"/>\n</f></f></identifier>\n\t<delegate public=\"1\" set=\"method\" line=\"283\" override=\"1\"><f a=\"\"><x path=\"Map\">\n\t<c path=\"String\"/>\n\t<c path=\"m3.observable.MappedSet.U\"/>\n</x></f></delegate>\n\t<identify set=\"method\" line=\"287\"><f a=\"u\">\n\t<c path=\"m3.observable.MappedSet.U\"/>\n\t<c path=\"String\"/>\n</f></identify>\n\t<iterator public=\"1\" set=\"method\" line=\"298\" override=\"1\"><f a=\"\"><t path=\"Iterator\"><c path=\"m3.observable.MappedSet.U\"/></t></f></iterator>\n\t<mapListen public=\"1\" set=\"method\" line=\"302\"><f a=\"f\">\n\t<f a=\"::\">\n\t\t<c path=\"m3.observable.MappedSet.T\"/>\n\t\t<c path=\"m3.observable.MappedSet.U\"/>\n\t\t<c path=\"m3.observable.EventType\"/>\n\t\t<x path=\"Void\"/>\n\t</f>\n\t<x path=\"Void\"/>\n</f></mapListen>\n\t<current public=\"1\" set=\"method\" line=\"306\"><f a=\"t_in\">\n\t<c path=\"m3.observable.MappedSet.T\"/>\n\t<c path=\"m3.observable.MappedSet.T\"/>\n</f></current>\n\t<new public=\"1\" set=\"method\" line=\"253\"><f a=\"source:mapper:?remapOnUpdate\">\n\t<c path=\"m3.observable.OSet\"><c path=\"m3.observable.MappedSet.T\"/></c>\n\t<f a=\"\">\n\t\t<c path=\"m3.observable.MappedSet.T\"/>\n\t\t<c path=\"m3.observable.MappedSet.U\"/>\n\t</f>\n\t<unknown/>\n\t<x path=\"Void\"/>\n</f></new>\n</class>";
