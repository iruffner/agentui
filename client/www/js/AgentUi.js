...
var defineWidget = function() {
	return { _create : function() {
		...
		var profile = m3.helper.OSetHelper.getElement(qoid.Qoid.profiles,self.options.notification.props.connectionIid);
		if(profile != null) {
