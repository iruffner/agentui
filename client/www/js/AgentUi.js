...
m3.observable.MappedSet = function(source,mapper,remapOnUpdate) {
	if(remapOnUpdate == null) remapOnUpdate = true;
	var _g = this;
	m3.observable.AbstractSet.call(this);
	...
	this._source.listen(function(t,type) {
		...
		} else if(type.isUpdate() && !_g._remapOnUpdate) mappedValue = _g._mappedSet.get(key); else {
...
ui.model.EMEvent.DELETE_NOTIFICATION = ["DELETE_NOTIFICATION",26];
ui.model.EMEvent.DELETE_NOTIFICATION.toString = $estr;
ui.model.EMEvent.DELETE_NOTIFICATION.__enum__ = ui.model.EMEvent;
ui.model.EMEvent.CONNECTION_UPDATE = ["CONNECTION_UPDATE",27];
...
ui.model.ModelObj = function() {
	this.set_uid(m3.util.UidGenerator.create());
};
...
ui.model.ModelObj.prototype = {
	...
	,get_uid: function() {
		if(m3.helper.StringHelper.isBlank(this.uid)) this.set_uid(m3.util.UidGenerator.create());
		return this.uid;
	}
...
ui.model.Content.getTimestamp = function(t) {
...
var defineWidget = function() {
	return { options : { itemsClass : null}, _create : function() {
		...
		ui.model.EM.addListener(ui.model.EMEvent.DELETE_NOTIFICATION,new ui.model.EMListener(function(notification1) {
			...
			Lambda.iter(self.connectionsMap,function(cc) {
				if(ui.widget.ConnectionCompHelper.connection(cc).equals(conn2)) {
					ui.widget.ConnectionCompHelper.deleteNotification(cc,notification1);
					cc.prependTo(selfElement);
				}
			});
