...
class BasicComparator extends TypeComparator {
	var valueType: ValueType;
	public function new(valueType: ValueType) {
		this.valueType = valueType;
	}
	override public function canCompare(vt: ValueType) {
		return valueType == vt;
	}
	override public function equivalent(path: VariablePath, left: Dynamic, right: Dynamic): Bool {
		return left == right;
	}
}

class ArrayComparator extends TypeComparator {
	public function new() {
	}
	override public function canCompare(vt: ValueType) {
...
class ClassComparator extends TypeComparator {
...
class EnumComparator extends TypeComparator {
	public function new() {
	}
	override public function canCompare(vt: ValueType) {
...
class ObjectComparator extends TypeComparator {
