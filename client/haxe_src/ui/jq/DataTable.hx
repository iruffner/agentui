...
typedef DataTableOptions = {
	...
	@:optional var aoColumns:Dynamic;
...
extern class DataTable extends JQ{
	...
	public function fnDeleteRow(row:HtmlDom):Void;
	...
	public function fnGetPosition(node: HtmlDom): Array<Int>;
	@:overload(function(node: HtmlDom, ?int: Int): Dynamic{})
	...
	**/
	static var cur(getCurrent, null) : DataTable;
	private static inline function getCurrent() : DataTable {
